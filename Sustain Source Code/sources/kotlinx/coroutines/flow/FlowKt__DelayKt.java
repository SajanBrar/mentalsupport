...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1572debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m1525toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m1573sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m1525toDelayMillisLRDsOJo(j));
    }
}
