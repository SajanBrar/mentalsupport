...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int i) {
            ...
            } while (!ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m(this.values, i, obj, (Object) null));
        ...
        public final Object putImpl(K k, V v, HashedWeakRef<K> hashedWeakRef) {
            ...
            } while (!ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m(this.values, index, obj, v));
            return obj;
        }
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (!(obj2 instanceof Marked)) {
                            if (ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m(this.values, i2, obj2, ConcurrentWeakMapKt.mark(obj2))) {
                                break;
                            }
                        } else {
