...
public final class DelayKt {
    ...
    public static final Object m1524delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1525toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1525toDelayMillisLRDsOJo(long j) {
        if (Duration.m1359compareToLRDsOJo(j, Duration.Companion.m1462getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1378getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
