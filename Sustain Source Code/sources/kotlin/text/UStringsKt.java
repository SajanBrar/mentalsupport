...
public final class UStringsKt {
    ...
    public static final String m1343toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1345toStringolVBNx4(short s, int i) {
    ...
    public static final String m1344toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1342toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m114unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m374unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m270unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (UnsignedKt.uintCompare(r1, UInt.m141constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m59boximpl(UByte.m65constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m192unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m141constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m319boximpl(UShort.m325constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m141constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (UnsignedKt.uintCompare(i3, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m394uintDivideJ1ME1BU(-1, r3);
                    if (UnsignedKt.uintCompare(i3, i4) > 0) {
                    }
                }
                return null;
            }
            int r2 = UInt.m141constructorimpl(i3 * r3);
            int r7 = UInt.m141constructorimpl(UInt.m141constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m219constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            if (UnsignedKt.ulongCompare(j, j2) > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = UnsignedKt.m396ulongDivideeb3DHEI(-1, r5);
                    if (UnsignedKt.ulongCompare(j, j2) > 0) {
                    }
                }
                return null;
            }
            long r9 = ULong.m219constructorimpl(j * r5);
            long r13 = ULong.m219constructorimpl(ULong.m219constructorimpl(((long) UInt.m141constructorimpl(digitOf)) & 4294967295L) + r9);
