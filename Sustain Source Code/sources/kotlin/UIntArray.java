...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static final /* synthetic */ UIntArray m193boximpl(int[] iArr) {
    ...
    public static boolean m198equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual((Object) iArr, (Object) ((UIntArray) obj).m209unboximpl());
    }
    ...
    public static final int m200getpVg5ArA(int[] iArr, int i) {
        return UInt.m141constructorimpl(iArr[i]);
    }
    ...
    public static java.util.Iterator<UInt> m204iteratorimpl(int[] iArr) {
    ...
    private static final class Iterator implements java.util.Iterator<UInt>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ Object next() {
            return UInt.m135boximpl(m210nextpVg5ArA());
        }
    ...
    public static boolean m197containsAllimpl(int[] iArr, Collection<UInt> collection) {
        ...
        for (Object next : iterable) {
            if (!(next instanceof UInt) || !ArraysKt.contains(iArr, ((UInt) next).m192unboximpl())) {
                z = false;
                continue;
            } else {
                z = true;
