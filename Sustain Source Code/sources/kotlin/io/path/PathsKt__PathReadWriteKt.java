...
class PathsKt__PathReadWriteKt {
    static /* synthetic */ InputStreamReader reader$default(Path path, Charset charset, OpenOption[] openOptionArr, int i, Object obj) throws IOException {
        ...
        return new InputStreamReader(Trace$$ExternalSyntheticApiModelOutline0.m(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset);
    }
    ...
    static /* synthetic */ BufferedReader bufferedReader$default(Path path, Charset charset, int i, OpenOption[] openOptionArr, int i2, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(openOptionArr, "options");
        return new BufferedReader(new InputStreamReader(Trace$$ExternalSyntheticApiModelOutline0.m(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset), i);
    }
    ...
    static /* synthetic */ OutputStreamWriter writer$default(Path path, Charset charset, OpenOption[] openOptionArr, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(openOptionArr, "options");
        return new OutputStreamWriter(Trace$$ExternalSyntheticApiModelOutline0.m(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset);
    }
    ...
    static /* synthetic */ BufferedWriter bufferedWriter$default(Path path, Charset charset, int i, OpenOption[] openOptionArr, int i2, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(openOptionArr, "options");
        return new BufferedWriter(new OutputStreamWriter(Trace$$ExternalSyntheticApiModelOutline0.m(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset), i);
    }
    ...
    private static final byte[] readBytes(Path path) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        byte[] m = Trace$$ExternalSyntheticApiModelOutline0.m(path);
    ...
    private static final void appendBytes(Path path, byte[] bArr) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(bArr, "array");
        Path unused = Files.write(path, bArr, new OpenOption[]{Trace$$ExternalSyntheticApiModelOutline0.m((Object) Trace$$ExternalSyntheticApiModelOutline0.m())});
    }
    ...
    public static final java.lang.String readText(java.nio.file.Path r3, java.nio.charset.Charset r4) throws java.io.IOException {
        /*
            ...
            java.io.InputStream r3 = androidx.tracing.Trace$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r3, (java.nio.file.OpenOption[]) r0)
            r2.<init>(r3, r4)
    ...
    public static final void writeText(java.nio.file.Path r1, java.lang.CharSequence r2, java.nio.charset.Charset r3, java.nio.file.OpenOption... r4) throws java.io.IOException {
        /*
            ...
            java.io.OutputStream r1 = androidx.tracing.Trace$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r1, (java.nio.file.OpenOption[]) r4)
    ...
    public static final void appendText(java.nio.file.Path r3, java.lang.CharSequence r4, java.nio.charset.Charset r5) throws java.io.IOException {
        /*
            ...
            java.nio.file.StandardOpenOption r1 = androidx.tracing.Trace$$ExternalSyntheticApiModelOutline0.m()
            java.nio.file.OpenOption r1 = androidx.tracing.Trace$$ExternalSyntheticApiModelOutline0.m((java.lang.Object) r1)
            r2 = 0
            r0[r2] = r1
            java.io.OutputStream r3 = androidx.tracing.Trace$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r3, (java.nio.file.OpenOption[]) r0)
    ...
    static /* synthetic */ void forEachLine$default(java.nio.file.Path r0, java.nio.charset.Charset r1, kotlin.jvm.functions.Function1 r2, int r3, java.lang.Object r4) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            java.io.BufferedReader r0 = androidx.tracing.Trace$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r0, (java.nio.charset.Charset) r1)
    ...
    private static final void forEachLine(java.nio.file.Path r2, java.nio.charset.Charset r3, kotlin.jvm.functions.Function1<? super java.lang.String, kotlin.Unit> r4) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r4, r0)
            java.io.BufferedReader r2 = androidx.tracing.Trace$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r2, (java.nio.charset.Charset) r3)
    ...
    private static final InputStream inputStream(Path path, OpenOption... openOptionArr) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(openOptionArr, "options");
        InputStream m = Trace$$ExternalSyntheticApiModelOutline0.m(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length));
    ...
    private static final OutputStream outputStream(Path path, OpenOption... openOptionArr) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(openOptionArr, "options");
        OutputStream m = Trace$$ExternalSyntheticApiModelOutline0.m(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length));
    ...
    static /* synthetic */ List readLines$default(Path path, Charset charset, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        List m = Trace$$ExternalSyntheticApiModelOutline0.m(path, charset);
    ...
    private static final List<String> readLines(Path path, Charset charset) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        List<String> m = Trace$$ExternalSyntheticApiModelOutline0.m(path, charset);
        Intrinsics.checkNotNullExpressionValue(m, "readAllLines(this, charset)");
        return m;
    }
    ...
    static /* synthetic */ Path appendLines$default(Path path, Iterable iterable, Charset charset, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(iterable, "lines");
        Intrinsics.checkNotNullParameter(charset, "charset");
        Path m = Files.write(path, iterable, charset, new OpenOption[]{Trace$$ExternalSyntheticApiModelOutline0.m((Object) Trace$$ExternalSyntheticApiModelOutline0.m())});
    ...
    static /* synthetic */ Path appendLines$default(Path path, Sequence sequence, Charset charset, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(sequence, "lines");
        Intrinsics.checkNotNullParameter(charset, "charset");
        Path m = Files.write(path, SequencesKt.asIterable(sequence), charset, new OpenOption[]{Trace$$ExternalSyntheticApiModelOutline0.m((Object) Trace$$ExternalSyntheticApiModelOutline0.m())});
