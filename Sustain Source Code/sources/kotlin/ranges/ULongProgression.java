...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m219constructorimpl(j ^ ULong.m219constructorimpl(j >>> 32))) * 31) + ((int) ULong.m219constructorimpl(j2 ^ ULong.m219constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(ULong.m264toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m264toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1281fromClosedRange7ftBX0g(long j, long j2, long j3) {
