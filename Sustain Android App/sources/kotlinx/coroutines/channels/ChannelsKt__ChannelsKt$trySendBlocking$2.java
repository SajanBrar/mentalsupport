    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m47constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m47constructorimpl(Unit.INSTANCE);
        if (Result.m54isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1560successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1558closedJP2dKIU(Result.m50exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1545boximpl(obj3);
    }
}
