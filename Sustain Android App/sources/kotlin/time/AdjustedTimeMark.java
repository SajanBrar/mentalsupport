...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m1354minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1498minusLRDsOJo(this, j);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1353getAdjustmentUwyO8pc() {
    ...
    public long m1352elapsedNowUwyO8pc() {
        return Duration.m1395minusLRDsOJo(this.mark.m1495elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1355plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1396plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
